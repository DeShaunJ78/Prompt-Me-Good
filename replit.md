...
*   **Cache-buster:** `pmg-chassis-v3.css` at `cv3-25`, `pmg-chassis-v3.js` at `cv3-19`. `pmg-visual-studio.{css,js}` at `vs-16`; `pmg-storyboard.css` at `sb-7`, `pmg-storyboard.js` at `sb-8`. Brand assets (`pmg-logo.png`, `favicon-32.png`, `favicon-48.png`) use `?v=5`.
