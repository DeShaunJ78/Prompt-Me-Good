...
*   **Cache-busters:** Bump query string on changed `pmg-*.{css,js}` (current image-mode-cleanup buster: `t140-image-mode-removed`; current visual-studio buster: `mux-2-adv-tuning`). Brand assets `?v=5`.
