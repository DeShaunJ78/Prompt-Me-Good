 ...
 * cap). This route enforces the global daily cost guard and charges the
 * generate cost bucket; each downstream /api/image call is charged separately.
 * ============================================================================ */
router.post("/storyboard", generateLimiter, generateCostCheck, async (req, res) => {
 ...
 * ============================================================================ */
router.post("/clarify", rateLimit, generateCostCheck, async (req, res) => {
...
router.post("/refine-prompt", rateLimit, generateCostCheck, async (req, res) => {
...
router.post("/image-prompt", rateLimit, generateCostCheck, async (req, res) => {
