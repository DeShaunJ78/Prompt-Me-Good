...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '[data-theme="dark"] .pmg-strength-pill[data-level="too-short"] .pmg-strength-dot { background: var(--color-muted); }',
      '[data-theme="dark"] .pmg-strength-dot { background: var(--color-muted); }',
...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '  background: color-mix(in srgb, var(--color-danger-strong) 10%, var(--color-surface-2)) !important;',
      '  color: var(--color-danger-strong) !important;',
      '  border: 1px solid color-mix(in srgb, var(--color-danger-strong) 25%, var(--color-border)) !important;',
      '}',
      ...
      '  background: color-mix(in srgb, var(--color-danger) 10%, var(--color-surface-2)) !important;',
...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      /* DESTRUCTIVE */
      '.btn-destructive, [data-destructive="true"], #clear-history-btn { background: color-mix(in srgb, var(--color-danger-strong) 10%, var(--color-surface-2)) !important; color: var(--color-danger-strong) !important; border: 1px solid color-mix(in srgb, var(--color-danger-strong) 25%, var(--color-border)) !important; }',
      '[data-theme="dark"] .btn-destructive, [data-theme="dark"] [data-destructive="true"], [data-theme="dark"] #clear-history-btn { color: var(--color-danger) !important; background: color-mix(in srgb, var(--color-danger) 10%, var(--color-surface-2)) !important; border-color: color-mix(in srgb, var(--color-danger) 30%, var(--color-border)) !important; }',
...
(function pmgT22PhaseBPostResult() {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '  background: color-mix(in srgb, var(--color-danger-vivid) 10%, var(--color-surface));',
      '  border-color: var(--color-danger-vivid);',
      '  color: var(--color-danger-vivid);',
      '}',
      '[data-theme="dark"] #' + SECONDARY_ROW_ID + ' .pmg-sec-btn.is-danger:hover {',
      '  background: color-mix(in srgb, var(--color-danger-vivid) 12%, var(--color-surface));',
      '  border-color: var(--color-danger-vivid);',
      '  color: var(--color-danger-vivid);',
      '}',
...
(function pmgT23PhotoSuite() {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '#' + SUITE_ID + ' .pmg-photo-clear:hover { color: var(--color-danger-vivid); border-color: var(--color-danger-vivid); }',
      '[data-theme="dark"] #' + SUITE_ID + ' .pmg-photo-clear:hover { color: var(--color-danger-vivid); border-color: var(--color-danger-vivid); }',
      ...
      '  color: var(--color-danger-vivid); outline: none;',
      '}',
      ...
      '  background: color-mix(in srgb, var(--color-danger-vivid) 12%, transparent);',
      '  color: var(--color-danger-vivid); outline: none;',
      '}',
...
(function pmgT30HelpAndImageWizard() {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '[data-theme="dark"] .pmg-most-loved-inline { background: rgba(255,193,7,0.22) !important; color: var(--color-warning) !important; }',
      '@media (max-width: 600px) {',
...
(function pmgT101PowerMoves() {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '  gap: 8px;',
      '}',
      '#' + SECTION_ID + ' .pmg-pm-grid .pmg-pm-chip {',
      '  flex: 1 1 0%;',
      '  min-width: 0;',
      '}',
...
(function __pmgT103UXOverhaul() {
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      '  #pmg-power-moves .pmg-pm-grid { gap: 6px !important; }',
...
(function pmgT122WorkstationTour() {
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      '}',
      '#' + OVERLAY_ID + '.is-open { display: block; pointer-events: auto; }',
      '#' + OVERLAY_ID + ' .ws-backdrop {',
      '  position: absolute; inset: 0; background: color-mix(in srgb, #000 12%, transparent);',
      '  pointer-events: inherit; opacity: 0; transition: opacity 0.18s ease-out;',
      '}',
  ...
  function nextStep() {
    ...
    var overlay = document.getElementById(OVERLAY_ID);
    overlay.classList.add('is-transitioning');
    setTimeout(function () { positionStep(); }, 150);
  }
