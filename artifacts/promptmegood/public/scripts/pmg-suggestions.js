...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '  color: var(--color-danger); border-color: var(--color-danger-light); outline: none;',
      '}',
      ...
      '  color: #fff; background: var(--color-danger); border-color: var(--color-danger);',
      '}',
      ...
      '  border: 1px solid color-mix(in srgb, var(--color-danger) 40%, var(--color-border)) !important;',
      ...
      '  background: color-mix(in srgb, var(--color-danger) 18%, var(--color-surface)) !important;',
      '}',
      ...
      '  font-weight: 700; color: var(--color-danger); background: transparent;',
      '  border: 1px solid color-mix(in srgb, var(--color-danger) 30%, transparent);',
      '  border-radius: var(--radius-full, 999px); cursor: pointer;',
      '}',
      '#' + NEG_ROW_ID + ' .pmg-neg-clear:hover,',
      '#' + NEG_ROW_ID + ' .pmg-neg-clear:focus-visible {',
      '  background: color-mix(in srgb, var(--color-danger) 12%, transparent); outline: none;',
      '}',
      '[data-theme="dark"] #' + SUITE_ID + ' .pmg-photo-pill.is-negative { color: var(--color-danger) !important; }',
      '[data-theme="dark"] #' + NEG_ROW_ID + ' { color: var(--color-danger); }',
      '[data-theme="dark"] #' + NEG_ROW_ID + ' .pmg-neg-clear { color: var(--color-danger); border-color: color-mix(in srgb, var(--color-danger) 35%, transparent); }',
      '[data-theme="dark"] #' + NEG_ROW_ID + ' .pmg-neg-clear:hover, [data-theme="dark"] #' + NEG_ROW_ID + ' .pmg-neg-clear:focus-visible { background: color-mix(in srgb, var(--color-danger) 12%, transparent); }',
