                  ...
                  '<div class="pmgv3-if-card">',
                    ...
                    '<div class="pmgv3-if-ba">',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-before">',
                        ...
                        '<div class="pmgv3-if-ba-text">"write me a youtube hook about quitting my 9-5 to sell sourdough"</div>',
                      '</div>',
                      ...
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-after">',
                        ...
                        '<div class="pmgv3-if-ba-text">"Act as a viral YouTube strategist. Write a 60-second hook for a video titled \u2018I Quit My $140K Tech Job to Bake Sourdough\u2019. Open with a 3-second pattern interrupt, plant one open loop, and keep the tone conversational \u2014 like you\u2019re telling a friend at a bar."</div>',
                      '</div>',
                    '</div>',
                  '</div>',
                  '<div class="pmgv3-if-card">',
                    ...
                    '<div class="pmgv3-if-ba">',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-before">',
                        '<div class="pmgv3-if-ba-tag">Before</div>',
                        '<div class="pmgv3-if-ba-text">"write a product description for my soy candle"</div>',
                      '</div>',
                      '<div class="pmgv3-if-ba-arrow" aria-hidden="true">\u2192</div>',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-after">',
                        '<div class="pmgv3-if-ba-tag">After</div>',
                        '<div class="pmgv3-if-ba-text">"Write a high-converting product description for the \u2018Midnight Library\u2019 soy candle \u2014 black fig, oud, and aged paper. Lead with the ritual of unwinding after a long day, use three short bullets for scent notes, burn time (45 hrs), and hand-poured origin, then close with the CTA \u2018Light yours tonight.\u2019"</div>',
                      '</div>',
                    '</div>',
                  '</div>',
                '</div>',
