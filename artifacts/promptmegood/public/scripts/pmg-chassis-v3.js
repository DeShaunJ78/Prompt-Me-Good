                  ...
                  '<div class="pmgv3-if-card">',
                    ...
                    '<div class="pmgv3-if-ba">',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-before">',
                        ...
                        '<div class="pmgv3-if-ba-text">"write me a youtube hook about [topic]"</div>',
                      '</div>',
                      ...
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-after">',
                        ...
                        '<div class="pmgv3-if-ba-text">"Act as a viral YouTube strategist. Write a 60-second hook for a video about [TOPIC]. Use high-retention pacing, open loops, and a conversational tone."</div>',
                      '</div>',
                    '</div>',
                  '</div>',
                  '<div class="pmgv3-if-card">',
                    ...
                    '<div class="pmgv3-if-ba">',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-before">',
                        '<div class="pmgv3-if-ba-tag">Before</div>',
                        '<div class="pmgv3-if-ba-text">"write a product description for [product]"</div>',
                      '</div>',
                      '<div class="pmgv3-if-ba-arrow" aria-hidden="true">\u2192</div>',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-after">',
                        '<div class="pmgv3-if-ba-tag">After</div>',
                        '<div class="pmgv3-if-ba-text">"Write a high-converting product description for [PRODUCT]. Focus on emotional benefits over features, use bullet points for readability, and end with a strong CTA."</div>',
                      '</div>',
                    '</div>',
                  '</div>',
                '</div>',
