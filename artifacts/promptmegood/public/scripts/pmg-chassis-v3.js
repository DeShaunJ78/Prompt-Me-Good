                  ...
                  '<div class="pmgv3-if-card">',
                    ...
                    '<div class="pmgv3-if-ba">',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-before">',
                        ...
                        '<div class="pmgv3-if-ba-text">"instagram caption for a reel about saving money on groceries"</div>',
                      '</div>',
                      ...
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-after">',
                        ...
                        '<div class="pmgv3-if-ba-text">"Write an Instagram Reel caption (under 220 characters) for a video on cutting a weekly grocery bill from $200 to $120. Open with a specific dollar claim in the first line, give two quick value bullets, end with a save-this-for-later CTA, and add 8 niche hashtags mixing #budgetmeals, #aldi, and #frugalliving."</div>',
                      '</div>',
                    '</div>',
                  '</div>',
                  '<div class="pmgv3-if-card">',
                    ...
                    '<div class="pmgv3-if-ba">',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-before">',
                        '<div class="pmgv3-if-ba-tag">Before</div>',
                        '<div class="pmgv3-if-ba-text">"cold email to a marketing director about my web design services"</div>',
                      '</div>',
                      '<div class="pmgv3-if-ba-arrow" aria-hidden="true">\u2192</div>',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-after">',
                        '<div class="pmgv3-if-ba-tag">After</div>',
                        '<div class="pmgv3-if-ba-text">"Write a cold email to the Head of Marketing at a mid-size B2B SaaS company pitching freelance web design. Subject line under 6 words. Open with one specific observation about their site (not a generic compliment), state the offer in one sentence, include one short proof point, and close with a low-friction ask \u2014 a 10-minute call, not a demo. Keep it under 90 words."</div>',
                      '</div>',
                    '</div>',
                  '</div>',
                '</div>',
