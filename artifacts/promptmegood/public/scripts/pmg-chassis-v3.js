        ...
        '<div class="pmgv3-right">',
                  ...
                  '<div class="pmgv3-if-card">',
                    ...
                    '<div class="pmgv3-if-ba">',
                      ...
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-after">',
                        ...
                        '<div class="pmgv3-if-ba-text">"Act as a 7-figure reseller who has scaled stores on eBay, Poshmark, and Amazon FBA. Build me a 30-day plan to launch a sneaker + streetwear reselling side hustle with $500 to start. Cover: the 3 best sourcing channels (thrift, outlet, online arbitrage), a target 40% net margin formula, an SEO-optimized listing template (title \u2192 bullets \u2192 description), the exact pricing + photo standards that beat undercutters, and which marketplace to launch on first based on speed of sale."</div>',
                      '</div>',
                    '</div>',
                  '</div>',
                  '<div class="pmgv3-if-card">',
                    ...
                    '<div class="pmgv3-if-ba">',
                      ...
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-after">',
                        '<div class="pmgv3-if-ba-tag">After</div>',
                        '<div class="pmgv3-if-ba-text">"Act as a freelance strategist who has built a $15K/month AI services agency from zero. Build me a 30-day launch plan to sell AI-powered services to small businesses. Cover: 3 productized offers under $1,500 (e.g. AI chatbot setup, automated content engine, custom GPT for ops), a positioning statement that doesn\u2019t sound like every other \u2018AI guy\u2019, the exact outreach playbook for landing my first 3 paying clients on Upwork + LinkedIn, and a delivery workflow that uses ChatGPT, Zapier, and Make.com so each project takes under 6 hours."</div>',
                      '</div>',
                    '</div>',
                  '</div>',
                '</div>',
          ...
          '<div class="output-box is-collapsed" id="prompt-output-box" style="display:none !important">',
            ...
            '<div class="pmgv3-send-grid send-to-row">',
              '<button class="btn-send-to" data-platform="chatgpt"    data-pmg-dest="chatgpt"    type="button">ChatGPT</button>',
              '<button class="btn-send-to" data-platform="claude"     data-pmg-dest="claude"     type="button">Claude</button>',
              '<button class="btn-send-to" data-platform="perplexity" data-pmg-dest="perplexity" type="button">Perplexity</button>',
              '<button class="btn-send-to" data-platform="gemini"     data-pmg-dest="gemini"     type="button">Gemini</button>',
            '</div>',
          '</div>',
        '</div>',
