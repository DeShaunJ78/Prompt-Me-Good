      ...
      '<div class="pmgv3-body" data-active-panel="text">',
        ...
        '<div class="pmgv3-right">',
          '<div class="pmgv3-right-placeholder" id="pmgv3-right-placeholder" aria-hidden="true">',
            ...
            '<div class="pmgv3-rp-title">Your engineered prompt will appear here</div>',
            '<div class="pmgv3-rp-sub">Describe your idea on the left, then hit <strong>Analyze My Idea</strong> to get started.</div>',
