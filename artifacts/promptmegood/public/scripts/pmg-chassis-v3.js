                  ...
                  '<div class="pmgv3-if-card">',
                    ...
                    '<div class="pmgv3-if-ba">',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-before">',
                        ...
                        '<div class="pmgv3-if-ba-text">"how do I make a youtube video that goes viral"</div>',
                      '</div>',
                      ...
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-after">',
                        ...
                        '<div class="pmgv3-if-ba-text">"Act as a YouTube growth strategist who has scaled three channels past 1M subscribers. Give me a viral video blueprint for a small channel (under 5K subs) in the personal-finance niche. Include: 5 title formulas using curiosity gaps, a thumbnail concept built on contrast and one bold word, a 15-second hook structure with a pattern interrupt, and 3 retention beats placed at 0:30, 2:00, and 5:00."</div>',
                      '</div>',
                    '</div>',
                  '</div>',
                  '<div class="pmgv3-if-card">',
                    ...
                    '<div class="pmgv3-if-ba">',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-before">',
                        '<div class="pmgv3-if-ba-tag">Before</div>',
                        '<div class="pmgv3-if-ba-text">"help me start a cleaning business"</div>',
                      '</div>',
                      '<div class="pmgv3-if-ba-arrow" aria-hidden="true">\u2192</div>',
                      '<div class="pmgv3-if-ba-col pmgv3-if-ba-after">',
                        '<div class="pmgv3-if-ba-tag">After</div>',
                        '<div class="pmgv3-if-ba-text">"Act as a small-business coach who has launched 20+ residential cleaning companies. Build me a 30-day launch plan to start a solo house-cleaning business with $500 startup capital. Cover: a starter supply list under $300, hourly + flat-rate pricing benchmarks for a mid-size US suburb, the exact 3 channels to land my first 5 paying clients in week one, and the legal basics (LLC, insurance, contractor agreement) in plain English."</div>',
                      '</div>',
                    '</div>',
                  '</div>',
                '</div>',
